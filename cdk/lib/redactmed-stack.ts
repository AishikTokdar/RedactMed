/**
 * CDK stack defining infrastructure for RedactMed platform.
...
const APP_NAME_LOWERCASE = 'redactmed';

/**
 * Infrastructure stack for RedactMed Platform.
 *
 * Creates:
 ...
 */
export class RedactMedStack extends Stack {
    ...
    const fn = new lambda.Function(this, config.functionName, {
      ...
      code: lambda.Code.fromAsset(this.backendRoot, {
          bundling: {
              ...
              volumes: [
                {
                  hostPath: path.join(os.homedir(), '.cache', 'redactmed-lambda-cache'),
